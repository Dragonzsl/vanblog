  ...
  return (
    <div>
      <a
        ...
        className="flex p-3 sm:p-4 dark:bg-dark card-shadow dark:card-shadow-dark transition sm:hover:-translate-y-3 hover:-translate-y-2 duration-300 linka-card"
      >
